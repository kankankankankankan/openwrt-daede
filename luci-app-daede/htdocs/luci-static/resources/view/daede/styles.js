...
const CSS = [
	...
	'.dd-quota-plan{flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-weight:600}',
	...
	'.dd-quota-percent{font-size:11px;opacity:.65;font-variant-numeric:tabular-nums}',
	...
	'.dd-member-head .dd-card-title{font-size:13px;opacity:1;margin:0;flex-shrink:0;text-transform:none;letter-spacing:0}',
	...
	'.dd-member-sync-control{display:flex!important;flex-flow:row nowrap!important;align-items:center;gap:7px;min-width:0}',
	'.dd-member-sync-control input{display:block;box-sizing:border-box;width:92px!important;flex:0 1 92px!important;min-width:72px}',
	'.dd-member-sync-control .cbi-button{flex:0 0 auto;height:32px;min-height:32px;margin:0;padding:4px 9px;font-size:11px;line-height:22px;white-space:nowrap}',
	'.dd-member-sync-feedback{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:500;opacity:.7}',
	'.dd-member-sync-feedback.dd-ok{color:#3da66a;opacity:1}',
	'.dd-member-sync-feedback.dd-error{color:#d96d6d;opacity:1}',
	'@media(max-width:640px){.dd-member-sync-control{flex-wrap:wrap!important}.dd-member-sync-feedback{flex:1 0 100%;padding-left:2px}}',
